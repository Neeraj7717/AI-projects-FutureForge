...
import io.unitycatalog.server.persist.utils.MapToJsonConverter;
...
public class VolumeInfoDAO extends IdentifiableDAO {
    ...
    @Convert(converter = MapToJsonConverter.class) // Use custom converter
    ...
    public VolumeInfo toVolumeInfo() {
        return new VolumeInfo()
            ...
            .name(getName())
            .comment(comment)
            .storageLocation(storageLocation != null ? FileOperations.convertRelativePathToURI(storageLocation) : null)
            .owner(owner)
            .createdAt(createdAt != null ? createdAt.getTime() : null)
            .createdBy(createdBy)
            .updatedAt(updatedAt != null ? updatedAt.getTime() : null)
            .updatedBy(updatedBy)
            .volumeType(volumeType != null ? VolumeType.valueOf(volumeType) : null)
    ...
    public static VolumeInfoDAO from(VolumeInfo volumeInfo) {
        ...
        return VolumeInfoDAO
            .builder()
            .id(UUID.fromString(volumeInfo.getVolumeId()))
            .name(volumeInfo.getName())
            .comment(volumeInfo.getComment())
            .storageLocation(volumeInfo.getStorageLocation() != null ? volumeInfo.getStorageLocation() : null)
            ...
            .volumeType(volumeInfo.getVolumeType() != null ? volumeInfo.getVolumeType().getValue() : null)
            .properties(volumeInfo.getProperties())
            .build();
    }
}
