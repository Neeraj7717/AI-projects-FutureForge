...
class TaskManager:
    ...
    def update_step(self, sessionId, step):
        ...
        self.mongodb.add_end_time(sessionId, step)
    ...
    def get_next_step(self, sessionId, sourceId, task, manualId, frame_bytes):
        ...
        if current_step == total_steps and task == 0:
            ...
            if not self.model:
                ...
                self.mongodb.insert_or_update_data(session_id=sessionId, steps=mongo_insertion)
                self.producer.send(
