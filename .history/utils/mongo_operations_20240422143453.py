...
class MongoDBConnector:
    ...
    def connect_insights(self):
        ...
        self.db_insight = self.client[self.database_name]
        self.collection_insight = self.db[self.insights_collection]
    ...
    def insert_or_update_data(self, session_id, steps):
        ...
        existing_data = self.collection.find_one({"sessionId": session_id})
        ...
        if existing_data:
            ...
            # Insert new document
            self.collection.insert_one({"sessionId": session_id, "steps": steps})
